...
function calculateCoordinates(firstNode, secondNode) {
    var treeContainerPadding = 5;
    var ele = document.getElementsByClassName("node")[firstNode];
    var ele2 = document.getElementsByClassName("node-container")[firstNode];
    var y = ele.offsetTop;
    var x = ele.offsetLeft;
    var h = ele.offsetHeight;
    var w = ele.offsetWidth;
    firstNodeOrd = y + (h / 2) + ele2.offsetTop;
    firstNodeAbs = x + (w / 2)  + ele2.offsetLeft;

    ele = document.getElementsByClassName("node")[secondNode];
    ele2 = document.getElementsByClassName("node-container")[secondNode];
    y = ele.offsetTop;
    x = ele.offsetLeft;
    h = ele.offsetHeight;
    w = ele.offsetWidth;
    secondNodeOrd = y + (h / 2) + ele2.offsetTop;
    secondNodeAbs = x + (w / 2) + ele2.offsetLeft;
}
